...
import io.github.leopard.framework.shiro.service.SysPasswordService;
...
public class SysIndexController extends BaseController
{
    ...
    public String index(ModelMap mmap)
    {
        ...
        mmap.put("copyrightYear", LeopardConfig.getCopyrightYear());
        mmap.put("demoEnabled", LeopardConfig.isDemoEnabled());
    ...
    {
        mmap.put("version", LeopardConfig.getVersion());
        return "main";
    }
